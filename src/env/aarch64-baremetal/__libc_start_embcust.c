...
static char *__embcust_argv_rw[EMBCUST_MAX_ARGV];
static char *__embcust_environ_rw[EMBCUST_MAX_ENVP];
static char __embcust_init_strpool[EMBCUST_MAX_INIT_STRPOOL];
